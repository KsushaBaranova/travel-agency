...
@WebServlet(urlPatterns="/createtour", name="CreateTourServlet")
public class CreateTourServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		request.getRequestDispatcher("WEB-INF/views/addTour.jsp").forward(request, response);
	}
